...
if (isset($_POST['upload'])
    ...
    $defaultSettings = '../templates/settings.vast.defaults.conf';
    ...
    $jsTemplate = '..' . DIRECTORY_SEPARATOR . 'templates' .
        DIRECTORY_SEPARATOR . $_POST['template'] . '.js';
  ...
  <body>
    ...
    <div class="container">
        ...
        <div id="votp" style="margin-top:80px;">
            ...
            <ul>
                <li><a href="settings/settings.vast.user.conf" target="_blank">Vast Template Configuration</a></li>
            </ul>
            <form method="post" enctype="multipart/form-data" action="index.php">
                ...
                <h4>3. Select where to upload.</h4>
                <input type="radio" name="production" value="false"> Local Server (Testing)<br>
                <input type="radio" name="production" value="true"> Production Server (CDN)<br>
